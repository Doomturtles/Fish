...
class EventEngine {
	...
	private:
		...
		bool keysLastFrame[Key::LAST];
		bool buttonsLastFrame[Mouse::BTN_LAST];
	...
	public:
		...
		*/
		...
		bool isDown(Key); //returns true the frame the button is pressed
		bool isDown(Mouse); //returns true the frame the mouse is pressed
